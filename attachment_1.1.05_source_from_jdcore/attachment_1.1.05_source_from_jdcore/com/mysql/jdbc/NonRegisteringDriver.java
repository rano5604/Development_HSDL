  ...
  implements Driver
{
  ...
  public static final String VERSION = "5.1.46";
    ...
    throws SQLException
  {
    ...
    required = true;
    description = Messages.getString("NonRegisteringDriver.3");
    
    DriverPropertyInfo portProp = new DriverPropertyInfo("PORT", info.getProperty("PORT", "3306"));
    required = false;
    description = Messages.getString("NonRegisteringDriver.7");
    ...
    required = true;
    description = Messages.getString("NonRegisteringDriver.13");
    
    DriverPropertyInfo passwordProp = new DriverPropertyInfo("password", info.getProperty("password"));
    required = true;
    description = Messages.getString("NonRegisteringDriver.16");
  ...
  public Properties parseURL(String url, Properties defaults) throws SQLException
  {
    ...
    int slashIndex = StringUtils.indexOfIgnoreCase(0, url, "/", "\"'", "\"'", StringUtils.SEARCH_MODE__ALL);
  ...
  public static boolean isHostPropertiesList(String host) { return (host != null) && (StringUtils.startsWithIgnoreCase(host, "address=")); }
  ...
  static class ConnectionPhantomReference extends PhantomReference<ConnectionImpl> { private NetworkResources io;
    ...
    ConnectionPhantomReference(ConnectionImpl connectionImpl, ReferenceQueue<ConnectionImpl> q) { super(q);
      try
      {
