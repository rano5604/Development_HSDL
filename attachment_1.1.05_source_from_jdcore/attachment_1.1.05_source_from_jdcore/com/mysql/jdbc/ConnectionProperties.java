...
public abstract interface ConnectionProperties
{
  ...
  public abstract void setNoTimezoneConversionForDateType(boolean paramBoolean);
  
  public abstract boolean getCacheDefaultTimezone();
  
  public abstract void setCacheDefaultTimezone(boolean paramBoolean);
  ...
  public abstract void setServerAffinityOrder(String paramString);
  ...
  public abstract void setIncludeThreadDumpInDeadlockExceptions(boolean paramBoolean);
  
  public abstract boolean getIncludeThreadNamesAsStatementComment();
  
  public abstract void setIncludeThreadNamesAsStatementComment(boolean paramBoolean);
  ...
  public abstract void setSendFractionalSeconds(boolean paramBoolean);
  ...
  public abstract void setLoadBalancePingTimeout(int paramInt)
    throws SQLException;
  
  public abstract boolean getLoadBalanceValidateConnectionOnSwapServer();
  
  public abstract void setLoadBalanceValidateConnectionOnSwapServer(boolean paramBoolean);
  
  public abstract String getLoadBalanceConnectionGroup();
  
  public abstract void setLoadBalanceConnectionGroup(String paramString);
  
  public abstract String getLoadBalanceExceptionChecker();
  
  public abstract void setLoadBalanceExceptionChecker(String paramString);
  
  public abstract String getLoadBalanceSQLStateFailover();
  
  public abstract void setLoadBalanceSQLStateFailover(String paramString);
  
  public abstract String getLoadBalanceSQLExceptionSubclassFailover();
  
  public abstract void setLoadBalanceSQLExceptionSubclassFailover(String paramString);
  
  public abstract boolean getLoadBalanceEnableJMX();
  
  public abstract void setLoadBalanceEnableJMX(boolean paramBoolean);
  
  public abstract void setLoadBalanceHostRemovalGracePeriod(int paramInt)
    throws SQLException;
  
  public abstract int getLoadBalanceHostRemovalGracePeriod();
  
  public abstract void setLoadBalanceAutoCommitStatementThreshold(int paramInt)
    throws SQLException;
  
  public abstract int getLoadBalanceAutoCommitStatementThreshold();
  
  public abstract void setLoadBalanceAutoCommitStatementRegex(String paramString);
  
  public abstract String getLoadBalanceAutoCommitStatementRegex();
  
  public abstract void setAuthenticationPlugins(String paramString);
  
  public abstract String getAuthenticationPlugins();
  
  public abstract void setDisabledAuthenticationPlugins(String paramString);
  
  public abstract String getDisabledAuthenticationPlugins();
  
  public abstract void setDefaultAuthenticationPlugin(String paramString);
  
  public abstract String getDefaultAuthenticationPlugin();
  
  public abstract void setParseInfoCacheFactory(String paramString);
  
  public abstract String getParseInfoCacheFactory();
  
  public abstract void setServerConfigCacheFactory(String paramString);
  
  public abstract String getServerConfigCacheFactory();
  
  public abstract void setDisconnectOnExpiredPasswords(boolean paramBoolean);
  
  public abstract boolean getDisconnectOnExpiredPasswords();
  
  public abstract boolean getAllowMasterDownConnections();
  
  public abstract void setAllowMasterDownConnections(boolean paramBoolean);
  
  public abstract boolean getAllowSlaveDownConnections();
  
  public abstract void setAllowSlaveDownConnections(boolean paramBoolean);
  
  public abstract boolean getReadFromMasterWhenNoSlaves();
  
  public abstract void setReadFromMasterWhenNoSlaves(boolean paramBoolean);
  
  public abstract boolean getReplicationEnableJMX();
  
  public abstract void setReplicationEnableJMX(boolean paramBoolean);
  
  public abstract void setGetProceduresReturnsFunctions(boolean paramBoolean);
  
  public abstract boolean getGetProceduresReturnsFunctions();
  
  public abstract void setDetectCustomCollations(boolean paramBoolean);
  ...
  public abstract void setServerRSAPublicKeyFile(String paramString)
    throws SQLException;
  
  public abstract boolean getAllowPublicKeyRetrieval();
  
  public abstract void setAllowPublicKeyRetrieval(boolean paramBoolean)
    throws SQLException;
  
  public abstract void setDontCheckOnDuplicateKeyUpdateInSQL(boolean paramBoolean);
  
  public abstract boolean getDontCheckOnDuplicateKeyUpdateInSQL();
  
  public abstract void setSocksProxyHost(String paramString);
  
  public abstract String getSocksProxyHost();
  
  public abstract void setSocksProxyPort(int paramInt)
    throws SQLException;
  ...
  public abstract void setReadOnlyPropagatesToServer(boolean paramBoolean);
  
  public abstract String getEnabledSSLCipherSuites();
  
  public abstract void setEnabledSSLCipherSuites(String paramString);
  
  public abstract String getEnabledTLSProtocols();
  
  public abstract void setEnabledTLSProtocols(String paramString);
  
  public abstract boolean getEnableEscapeProcessing();
  
  public abstract void setEnableEscapeProcessing(boolean paramBoolean);
}
